    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="pt-16 flex items-center justify-center min-h-screen p-4">
        <div className="max-w-md w-full">
          ...
          {/* Form */}
          <form onSubmit={handleSubmit} className="mt-8 bg-white dark:bg-gray-800 shadow-lg rounded-lg p-8">
            <div className="space-y-6">
              <div>
                ...
                <input
                  ...
                  autoComplete="email"
                  required
                  className="mt-1 block w-full px-3 py-2 border border-gray-300 dark:border-gray-700 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:focus:ring-blue-400 dark:focus:border-blue-400 dark:bg-gray-800 dark:text-white sm:text-sm"
